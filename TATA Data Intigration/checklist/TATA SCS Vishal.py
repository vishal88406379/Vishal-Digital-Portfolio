...
# List of all script paths (add the script names here)
scripts = [
    "Final Pending GRN.py",
    "Monthly Data Compilation CV & PV New.py",
    "Oeminvoice TATA CVBU.py",
    "Oeminvoice TATA PCBU.py",
    "Order sent for ONE specific.py",
    "Po locationwise TATA & CVBU.py",
    "Resrve Stock Final.py",
    "Final Pending GRN.py",
    "WIP FINAL.py"
    "Resrve Stock Final.py",
    "Resrve Stock Final CVBU",
    "Monthly Data Compiler by Folder",
    "WIP FINAL.py",
    "WIP FINAL CVBU",
    "TOC compilar file wise.py"
]
